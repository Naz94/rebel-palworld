  ...
  return (
    <section className="border-b border-white/10 px-5 py-4 md:px-8 xl:px-10">
      <div className="relative">
        ...
        {normalized && (
          <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-40 max-h-[520px] overflow-y-auto rounded-2xl border border-white/10 bg-[#11151a] p-2 shadow-2xl">
            {matches.length === 0 ? (
              ...
              <div className="space-y-1">
                {matches.map((entry) => (
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-4 rounded-xl px-3 py-3 text-left transition hover:bg-white/[0.06]"
                  >
      ...
      <aside className="relative z-10 h-full w-full max-w-lg overflow-y-auto border-l border-white/10 bg-[#11151a] shadow-2xl">
        ...
        <div className="p-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-2 sm:grid-cols-3">
            ...
            <DetailMetric label="Current" value={score.currentPower} />
            <DetailMetric label="Potential" value={score.combatPotential} />
