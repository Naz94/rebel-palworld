    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm">
      ...
      <aside className="relative z-10 h-full w-full max-w-3xl overflow-y-auto border-l border-white/10 bg-[#11151a] shadow-2xl">
        <div className="relative flex h-60 items-center justify-center bg-[#1a2027]">
          ...
          {pal.isAlpha && (
            <span className="absolute left-4 top-4 rounded-full bg-amber-400 px-3 py-1 text-base font-bold uppercase text-black">
              Alpha
            </span>
          )}

          <span className="absolute bottom-4 left-4 rounded-lg border border-white/10 bg-black/60 px-3 py-1.5 text-[13px] uppercase tracking-[0.14em] text-neutral-300">
            {bucketLabel}
          </span>
        </div>

        <div className="p-6">
          <p className="text-base uppercase tracking-[0.25em] text-neutral-500">
            Pal Inspector
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="rounded-lg border border-white/10 bg-black/20 px-2.5 py-1 text-[13px] text-neutral-400">
                {score.speciesRank
                  ? `#${score.speciesRank}`
                  : "—"}
              </span>
            ...
            {pal.slot.containerId && (
              <p
                ...
                className="mt-3 break-all text-[13px] leading-relaxed text-neutral-600"
              >
                Container ID:{" "}
                {
                  pal.slot
          ...
          <div className="mt-6 rounded-2xl border border-cyan-400/20 bg-cyan-400/[0.04] p-4">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="rounded-lg border border-cyan-400/20 bg-cyan-400/10 px-3 py-1.5 text-[13px] uppercase tracking-wide text-cyan-100">
            ...
            <div className="mt-3 space-y-1">
              {recommendationReasons.slice(0, 3).map((reason) => (
                <p key={reason} className="text-base leading-relaxed text-neutral-300">
                  ✓ {reason}
                </p>
              ))}
            </div>
          ...
          {pal.combatStats && (
            <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-md border border-white/10 bg-black/20 px-2 py-1 text-[13px] text-neutral-400">
                  {combatV2.confidence}
                </span>
              </div>
              ...
              <div className="mt-2 space-y-1">
                {combatV2.bestUsedFor.map((use) => (
                  <p key={use} className="text-base text-neutral-300">
                    ✓ {use}
                  </p>
                ))}
              </div>
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                <div className="rounded-xl border border-emerald-400/15 bg-emerald-400/[0.04] p-3">
                  <p className="text-[13px] uppercase tracking-[0.14em] text-emerald-300">
                ...
                <div className="rounded-xl border border-red-400/15 bg-red-400/[0.04] p-3">
                  <p className="text-[13px] uppercase tracking-[0.14em] text-red-300">
                    Threatened By
                  </p>
                  <p className="mt-1 text-base text-neutral-300">
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            ...
            <div className="mt-3 rounded-xl border border-violet-400/20 bg-violet-400/[0.04] p-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-md border border-violet-400/20 bg-violet-400/10 px-2 py-1 text-[13px] text-violet-200">
              ...
              <div className="mt-3 grid grid-cols-2 gap-1.5 sm:grid-cols-3">
                {Object.entries(score.investmentPlan.actions).map(([action, recommended]) => (
                  ...
                  >
                    <p className={recommended ? "text-[13px] text-emerald-200" : "text-[13px] text-neutral-600"}>
              ...
              <div className="mt-3 space-y-1">
                {score.investmentPlan.reasons.map((reason) => (
                  <p key={reason} className="text-base leading-relaxed text-neutral-400">
                    • {reason}
                  </p>
                ))}
              </div>
            ...
            {score.investmentReasons.length > 0 && (
              <div className="mt-3 space-y-1">
                {score.investmentReasons.map((reason) => (
                  <p key={reason} className="text-base text-neutral-300">✓ {reason}</p>
                ))}
              </div>
            )}
            ...
            {(pal.skills?.equipped?.length ?? 0) > 0 && (
              <div className="mt-4">
                <p className="text-[13px] uppercase tracking-[0.18em] text-neutral-500">Equipped Skills</p>
                <div className="mt-2 flex flex-wrap gap-2">
                  {pal.skills?.equipped.map((skill) => (
                    <span key={skill} className="rounded-lg border border-white/10 bg-black/20 px-2 py-1 text-[13px] text-neutral-300">
                      {humanizeSkill(skill)}
                    </span>
                  ))}
                </div>
            ...
            {(pal.progression?.workSuitabilityUpgrades?.length ?? 0) > 0 && (
              <div className="mt-4">
                <p className="text-[13px] uppercase tracking-[0.18em] text-neutral-500">Permanent Work Upgrades</p>
                <div className="mt-2 space-y-1">
                  {pal.progression?.workSuitabilityUpgrades.map((upgrade) => (
                    <p key={`${upgrade.workSuitability}-${upgrade.rank}`} className="text-base text-neutral-300">
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              ...
              <div className="mt-3 flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[13px] uppercase tracking-[0.16em] text-cyan-300">
              ...
              {partnerSkillDisplay.tags.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {partnerSkillDisplay.tags.map((tag) => (
                    <span key={tag} className="rounded-lg border border-white/10 bg-black/20 px-2.5 py-1 text-[13px] uppercase tracking-wide text-neutral-300">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-3">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {partnerSkillDisplay.bestUses.map((use) => (
                      <span key={use} className="rounded-lg border border-cyan-400/15 bg-cyan-400/[0.05] px-2.5 py-1 text-[13px] text-neutral-300">
                        ✓ {use}
                      </span>
                    ))}
                  </div>
          ...
          {pal.passives
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-1 text-[13px] uppercase tracking-[0.14em] text-neutral-500">
                            {intelligence.categories.join(" · ")}
                          </p>
                        </div>

                        <div className="flex shrink-0 flex-col items-end gap-1">
                          <span className={`rounded-md border px-2 py-1 text-[13px] ${dispositionStyle}`}>
                      ...
                      {intelligence.bestFor.length > 0 && (
                        <div className="mt-3 flex flex-wrap gap-2">
                          {intelligence.bestFor.map((role) => (
                            <span key={role} className="rounded-lg border border-white/10 bg-black/20 px-2.5 py-1 text-[13px] text-neutral-300">
                              ✓ {role}
                            </span>
                          ))}
                        </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 rounded-xl border border-white/10 bg-white/[0.03] p-3 text-base text-neutral-500">
          ...
          {pal.speciesUtility && (
            <div className="mt-6 rounded-2xl border border-emerald-400/15 bg-emerald-400/[0.03] p-4">
              ...
              <div className="mt-3">
                <p className="text-[13px] uppercase tracking-[0.16em] text-emerald-300">
                  Primary Utility
                </p>
              ...
              {pal.speciesUtility.speciesRoles.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {pal.speciesUtility.speciesRoles.map((role) => (
                    <span
                      key={role}
                      className="rounded-lg border border-emerald-400/15 bg-emerald-400/[0.06] px-2.5 py-1 text-[13px] text-emerald-100"
                    >
                      {role}
                    </span>
                  ))}
                ...
                <div className="rounded-xl border border-white/10 bg-black/20 p-3">
                  ...
                  <div className="mt-2 space-y-1">
                    {pal.speciesUtility.bestUsedFor.map((use) => (
                      <p key={use} className="text-base leading-relaxed text-neutral-300">
                        ✓ {use}
                      </p>
                    ))}
                  </div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="rounded-md bg-white/[0.06] px-2 py-1 text-base font-semibold">
                      {
                ...
                {score.workRoles.map(
                  (role) => (
                    <span
                      ...
                      className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-base"
                    >
                      {
                        role.role
                      }{" "}
          ...
          <details className="mt-6 rounded-xl border border-white/10 bg-white/[0.02] p-3">
            <summary className="cursor-pointer text-base font-medium text-neutral-300">
